...
<html lang="en">
<head>
    <title>Code coverage report for lib/providers/rest/wrappers.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/providers/rest/</a> wrappers.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    var params = _.extend({ query: req.query || <span class="branch-1 cbranch-no" title="branch not covered" >{} </span>}, _.omit(req.params || <span class="branch-1 cbranch-no" title="branch not covered" >{},</span> 'id'), req.feathers);
...
<span class="cstat-no" title="statement not covered" >        debug('Error in REST handler: `' + (error.message || error) + '`');</span>
