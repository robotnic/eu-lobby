...
<html lang="en">
<head>
    <title>Code coverage report for lib/providers/rest/index.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/providers/rest/</a> index.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    app.providers.push(function (path, service, options) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (app.disabled('feathers rest')) {
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
      var middleware = (options || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>.middleware || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
      var before = middleware.before || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
      var after = middleware.after || <span class="branch-1 cbranch-no" title="branch not covered" >[];</span>
&nbsp;
      var uri = path.indexOf('/') === 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >path </span>: '/' + path;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Jan 06 2016 12:50:50 GMT-0800 (PST)
</div>
</div>
