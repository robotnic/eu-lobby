...
<html lang="en">
<head>
    <title>Code coverage report for lib/providers/socket/primus.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">lib/providers/socket/</a> primus.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
      setup: function(server) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (this.disabled('feathers primus')) {
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof configurer === 'function') {
