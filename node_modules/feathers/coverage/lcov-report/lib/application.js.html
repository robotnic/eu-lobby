...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">lib/</a> application.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    _.each(this.providers, function (provider) {
      provider(location, protoService, options || <span class="branch-1 cbranch-no" title="branch not covered" >{})</span>;
    });
&nbsp;
    // If we ran setup already, set this service up explicitly
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this._isSetup &amp;&amp; typeof protoService.setup === 'function') {
