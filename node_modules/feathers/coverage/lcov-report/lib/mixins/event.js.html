...
<html lang="en">
<head>
    <title>Code coverage report for lib/mixins/event.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">lib/mixins/</a> event.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof service.mixin === 'function') {
    if(!isEmitter) {
...
&nbsp;
    if (typeof service[method] === 'function' &amp;&amp; !alreadyEmits) {
      ...
      emitter.on(eventName, function (results, args) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!results[0]) { // callback without error
