...
var Service = function () {
  ...
  _createClass(Service, [{
    ...
    value: function update(id, data, params) {
      ...
      return modelQuery.lean(this.lean).exec().catch(_errorHandler2.default);
    }
  }, {
    key: 'patch',
    value: function patch(id, data, params) {
      ...
      try {
        ...
        var query = (0, _lodash2.default)(params.query, '$populate');

        return this.Model.update(query, data, options).lean(this.lean).exec().then(function () {
