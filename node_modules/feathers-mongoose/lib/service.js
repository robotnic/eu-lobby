...
var Service = function () {
  ...
  _createClass(Service, [{
    ...
    value: function _find(params, count) {
      ...
      var filters = getFilter(queryParams);
      var query = this.Model.find(queryParams).lean(this.lean);
    ...
    value: function update(id, data) {
      ...
      var options = { new: true, overwrite: this.overwrite };
      ...
      return this.Model.findOneAndUpdate(_defineProperty({}, this.id, id), data, options).lean(this.lean).exec().then(function (result) {
        return result;
      }).catch(_errorHandler2.default);
    }
  }, {
    ...
    value: function patch(id, data, params) {
      ...
      return this.Model.update(params.query, { $set: data }, { multi: multi }).lean(this.lean).exec().then(function () {
